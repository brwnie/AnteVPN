...
public class Main extends JavaPlugin {
    ...
    private void saveIpWhitelistToDatabase() {
        ...
        String sql = "INSERT OR IGNORE INTO ante_good_ip(address) VALUES (?)";
    ...
    private void saveUuidWhitelistToDatabase() {
        ...
        String sql = "INSERT OR IGNORE INTO ante_good_uuid(uuid) VALUES (?)";
    ...
    private void saveBadToDatabase() {
        ...
        String sql = "INSERT OR IGNORE INTO ante_bad_address(address, timestamp) VALUES (?,?)";
